...
foreach ($phrase in @("synthetic", "local-first", "reversible", "human", "No upload", "AI-assisted", "not a regulated records system")) { if ($text -notmatch [Regex]::Escape($phrase)) { $failures.Add("Disclosure phrase missing: $phrase") } }
